report 50004 FS_RF_PurchaseInvoice
{
            ...
            dataitem(Line; "Purch. Inv. Line")
            {
                ...
                begin
                    ...
                    if PurchInvLine.Find('-')then begin
                        ...
                        repeat if(PurchInvLine."VAT Identifier" <> VATIdentifier) and (PurchInvLine.Quantity <> 0)then VATAmountText:=Text012;
    ...
    begin
        if LogInteraction and not IsReportInPreviewMode()then if Header.FindSet()then repeat SegManagement.LogDocument(14, Header."No.", 0, 0, Database::Vendor, Header."Buy-from Vendor No.", Header."Purchaser Code", '', Header."Posting Description", '');
                until Header.Next() = 0;
    end;
    trigger OnPreReport()
    begin
