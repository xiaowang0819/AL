report 50000 FS_RF_ServiceRequestConf
{
    WordLayout = './layouts/ServiceRequestConf.docx';
    Caption = 'Service Request - Confirmation';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Service Request (SO)';
    ...
    local procedure SetPurchaseLine(CommentLine: Boolean; Quantity: Decimal; UnitPrice: Decimal; VATPercentage: Decimal; LineAmount: Decimal; CurrencyCode: Code[10]; var FormattedQuantity: Text; var FormattedUnitPrice: Text; var FormattedVATPercentage: Text; var FormattedLineAmount: Text)
    var
